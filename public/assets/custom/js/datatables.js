"use strict";
var KTAppsEducationSchoolTeacher = {
    init: function() {
        var t;
        t = $("#kt_datatable").KTDatatable({
            data: {
                ...
                source: {
                    read: {
                        url: HOST_URL + "/api/teacher_activity.php"
                    }
                },
                pageSize: 10,
                serverPaging: !0,
            ...
            columns: [{
                ...
                width: 250,
                template: function(t) {
                    var a = "300_" + KTUtil.getRandomInt(1, 20) + ".jpg",
                        e = KTUtil.getRandomInt(1, 5);
                    return '<div class="d-flex align-items-center">\t\t\t\t\t\t\t<div class="symbol symbol-40 symbol-sm flex-shrink-0">\t\t\t\t\t\t\t\t<img class="" src="assets/media/users/' + a + '" alt="photo">\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t<div class="ml-4">\t\t\t\t\t\t\t\t<a href="#" class="text-dark-75 text-hover-primary font-weight-bolder font-size-lg mb-0">' + t.CompanyAgent + '</a>\t\t\t\t\t\t\t\t<div class="text-muted font-weight-bold">' + {
                        1: {
                ...
                title: "Department",
                template: function(t) {
                    return '<a href="#" class="text-dark-50 text-hover-primary font-weight-bold">' + t.CompanyName + "</a>"
                }
            }, {
                field: "JoinedDate",
                title: "Joined",
                ...
                format: "MM/DD/YYYY",
                template: function(t) {
                    return '<div class="font-weight-bolder text-primary mb-0">' + t.ShipDate + "</div>"
                }
            }, {
                field: "Status",
                title: "Status",
                ...
                template: function(t) {
                    ...
                    return '<span class="label label-lg font-weight-bold ' + e[a].class + ' label-inline">' + e[a].title + "</span>"
                }
            }, {
                field: "Actions",
                title: "Actions",
