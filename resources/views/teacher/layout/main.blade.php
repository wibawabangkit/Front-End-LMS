...
<body id="kt_body" class="page-loading-enabled page-loading header-fixed header-mobile-fixed page-loading">
    ...
    @include('teacher.layout.partials.header-mobile')

    <div class="d-flex flex-column flex-root">
        <div class="d-flex flex-row flex-column-fluid page">
            <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
                @include('teacher.layout.partials.header')
                @yield('content')
                @include('teacher.layout.partials.footer')
            </div>
        </div>
    </div>

    @include('teacher.layout.partials.user-panel')
